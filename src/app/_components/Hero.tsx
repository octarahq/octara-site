      ...
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-12 items-center">
        <div className="flex flex-col gap-8 flex-1">
          ...
          <div className="flex flex-wrap gap-4">
            <Link href="/api/discord" target="_blank" className="flex min-w-[160px] cursor-pointer items-center justify-center gap-2 rounded-xl h-14 px-6 bg-primary text-white text-base font-bold shadow-lg shadow-primary/25 hover:bg-primary/90 transition-all">
              <span className="material-symbols-outlined">chat</span>
              {t("hero.join_discord")}
            </Link>
            <Link href="/api/github" target="_blank" className="flex min-w-[160px] cursor-pointer items-center justify-center gap-2 rounded-xl h-14 px-6 bg-slate-200 dark:bg-slate-800 text-slate-900 dark:text-white text-base font-bold hover:bg-slate-300 dark:hover:bg-slate-700 transition-all">
        ...
        <div className="flex-1 w-full">
          <div className="relative group">
            ...
            <div className="relative w-full aspect-video lg:aspect-square bg-slate-200 dark:bg-slate-800 rounded-xl overflow-hidden border border-slate-300 dark:border-slate-700">
              <img src="/favicon.svg" alt="Octara" className="w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </div>
