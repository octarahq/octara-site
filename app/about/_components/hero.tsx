...
export default function Hero() {
  return (
    <section className="relative flex flex-col px-4 lg:px-24 h-[60vh] min-h-76 items-center justify-center overflow-visible">
      <motion.div
      ...
      >
        <div className="flex flex-col items-center text-center mt-20">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold pb-8 text-center flex flex-col items-center justify-center gap-2 md:gap-4">
            Innovate for a <br />
            <ScrambleText text="sustainable future." speed={50} />
          </h1>
          <p className="max-w-xl text-sm md:text-base text-muted-foreground text-center">
            Octara was born from a simple vision: to transform technology and make it accessible to everyone.
          </p>
        </div>
      </motion.div>
    </section>
