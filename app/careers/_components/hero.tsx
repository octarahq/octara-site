...
export default function Hero() {
  return (
    <section className="relative flex flex-col px-4 lg:px-24 h-screen min-h-76 items-center justify-center overflow-visible">
      <motion.div
      ...
      >
        <div className="flex flex-col items-center text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold pb-8 text-center flex flex-col items-center justify-center gap-2 md:gap-4">
            ...
            <ScrambleText text="We’re hiring!" speed={50} />
          </h1>
          <p className="max-w-md text-sm md:text-base text-muted-foreground text-center">
            We are building the future of open source technology. Octara is a
            community-driven initiative powered by passion and collective
            innovation.
          </p>
        </div>
      </motion.div>
